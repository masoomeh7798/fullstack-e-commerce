      ...
      <Stack  direction={'row'} my={{ xs: 2, md: 3 }} width={{ lg: '85%', sm: '90%', xs: "95%" }} mx={'auto'} gap={1}>
        ...
        <Stack flex={1} alignItems={'center'} gap={{ xs: 1, md: 2 }} direction={'row'} >
          <Box width={{ md: '45px', xs: "35px" }} height={{ md: '45px', xs: "35px" }}>
            <img width={'100%'} height={'100%'} src='../../public/logoland3 (1).png' />
          </Box>
          <Typography noWrap color='var(--primary-clr)' fontSize={{xs: '16px',sm:"24px",md: '32px'}} fontWeight={'600'} component={'h1'}>رنگين مد</Typography>
        </Stack>
        {/* end logo section */}
        {/* strat search bar */}
